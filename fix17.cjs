...
const relatorios = `import React, { useEffect, useState } from "react"
...
export default function Relatorios() {
  ...
  function gerarPDF() {
    ...
    autoTable(doc, {
      startY: 25,
      head: [["ID", "Nome", "Sexo", "Raca", "Pelagem", "Castrado", "Peso(kg)", "Nascimento", "Veterinario"]],
      body: animais.map(a => [
        a.id,
        a.nome,
        ...
        a.raca || "-",
        a.pelagem || "-",
        a.castrado === true ? "Sim" : a.castrado === false ? "Nao" : "-",
        a.pesoAtual || "-",
    ...
    autoTable(doc, {
      startY: 25,
      head: [["ID", "Matriz", "Nascidos", "Vivos", "Mortalidade", "Peso Nascer", "Peso Desmame"]],
      body: ninhadas.map(n => [
        n.id,
        ...
        n.nascidosVivos,
        n.taxaMortalidade,
        n.pesoMedioNascer ? n.pesoMedioNascer + "g" : "-",
        n.pesoMedioDesmame ? n.pesoMedioDesmame + "g" : "-"
      ]),
      theme: "grid",
      headStyles: { fillColor: [45, 106, 79] }
    })
  ...
  function gerarExcel() {
    ...
    const aniData = [["ID", "Nome", "Sexo", "Raca", "Pelagem", "Castrado", "Peso (kg)", "Nascimento", "Veterinario", "Cadastrado em"]].concat(
      animais.map(a => [
        a.id,
        a.nome,
        a.sexo === "F" ? "Femea" : "Macho",
    ...
    const ninData = [["ID", "Matriz", "Nascidos", "Vivos", "Mortalidade", "Peso Nascer", "Peso Desmame"]].concat(
      ninhadas.map(n => [
        n.id,
        n.reproducao && n.reproducao.matriz ? n.reproducao.matriz.nome : "",
        n.totalNascidos,
    ...
    React.createElement("div", { style: estilosBase.container },
      ...
      React.createElement("main", { style: { ...estilosBase.main, maxWidth: 700 } },
        React.createElement("div", { style: estilosBase.card },
          ...
          React.createElement("p", { style: { fontSize: 14, color: cores.textoSecundario, marginBottom: 16 } },
            "Gere relatorios completos com dados de animais (raca, pelagem, peso, veterinario), reproducoes e ninhadas."
          ),
        ...
        React.createElement("div", { style: estilosBase.card },
          ...
          animais.map(function(a) {
            return React.createElement("div", { key: a.id, style: { padding: "10px 0", borderBottom: "0.5px solid " + cores.borda } },
              ...
              React.createElement("div", { style: { display: "flex", gap: 6, flexWrap: "wrap" } },
                ...
                a.veterinario && React.createElement("span", { style: { ...estilosBase.badge, background: "#f0f0f0", color: "#666", fontSize: 10 } }, "Vet: " + a.veterinario)
              )
            )
          })
        ),
        ...
        React.createElement("div", { style: estilosBase.card },
          ...
          ninhadas.map(function(n) {
            return React.createElement("div", { key: n.id, style: { display: "flex", justifyContent: "space-between", padding: "8px 0", borderBottom: "0.5px solid " + cores.borda } },
              React.createElement("span", { style: { fontSize: 14, color: cores.texto } }, "Ninhada #" + n.id + " - " + (n.reproducao && n.reproducao.matriz ? n.reproducao.matriz.n